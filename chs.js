...
var cnItems = {
    ...
    "IshaD": "伊沙德",
    "Lightning Rod. Your 1.00 rods are generating 1.00 Lightning/s": "避雷针。 你的 1.00 棒产生 1.00 Lightning/s",
...
var cnRegReplace = new Map([
    ...
    [/^Convert (.+) to (.+) Gasoline$/, '转换 $1 石油 为 $2 汽油。'],
    ...
    [/^Oil Drill (.+) Oil$/, '石油钻机开采 $1 石油'],
    [/^Drilling Platform (.+) Oil$/, '钻井平台开采 $1 石油'],
    [/^([\d\.]+) Scrap$/, '$1 废料'],
